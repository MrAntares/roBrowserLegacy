 ...
 */
const BasicInfoV4 = new GUIComponent('BasicInfoV4', cssText);
...
BasicInfoV4.init = function init() {
	...
	if (topbar) {
		topbar.addEventListener('dblclick', () => BasicInfoV4.toggleMode());
	}

	const rightBtn = root.querySelector('.topbar .right');
	if (rightBtn) {
		rightBtn.addEventListener('click', () => BasicInfoV4.toggleMode());
	}
