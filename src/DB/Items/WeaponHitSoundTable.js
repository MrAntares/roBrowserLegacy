...
define(["./WeaponType"], function( WeaponType )
{
	...
	WeaponSound[WeaponType.GUN_HANDGUN]           = ["_hit_±ÇÃÑ.wav"]; //_hit_±ÇÃÑ.wav
	WeaponSound[WeaponType.GUN_RIFLE]             = ["_hit_¶óÀÌÇÃ.wav"]; //_hit_¶óÀÌÇÃ.wav
	WeaponSound[WeaponType.GUN_GATLING]           = ["_hit_°³Æ²¸µÇÑ¹ß.wav"]; //_hit_°³Æ²¸µÇÑ¹ß.wav
	WeaponSound[WeaponType.GUN_SHOTGUN]           = ["_hit_¼¦°Ç.wav"]; //_hit_¼¦°Ç.wav
	WeaponSound[WeaponType.GUN_GRANADE]           = ["_hit_±×·¹³×ÀÌµå·±ÃÄ.wav"]; //_hit_±×·¹³×ÀÌµå·±ÃÄ.wav
