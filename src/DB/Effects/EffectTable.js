...
export default {
	...
	349: [{ type: 'WATERFALL', variant: 'large', vertical: false, height: 80 }], // EF_WATERFALL
	350: [{ type: 'WATERFALL', variant: 'large', vertical: true, height: 80 }], // EF_WATERFALL_90
	351: [{ type: 'WATERFALL', variant: 'small', vertical: false, height: 30 }], // EF_WATERFALL_SMALL
	352: [{ type: 'WATERFALL', variant: 'small', vertical: true, height: 30 }], // EF_WATERFALL_SMALL_90
	353: [{ type: 'WATERFALL', variant: 'dark-large', vertical: false, height: 80 }], // EF_WATERFALL_T2
	354: [{ type: 'WATERFALL', variant: 'dark-large', vertical: true, height: 80 }], // EF_WATERFALL_T2_90
	355: [{ type: 'WATERFALL', variant: 'dark-small', vertical: false, height: 30 }], // EF_WATERFALL_SMALL_T2
	356: [{ type: 'WATERFALL', variant: 'dark-small', vertical: true, height: 30 }], // EF_WATERFALL_SMALL_T2
