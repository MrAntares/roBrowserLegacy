...
define(['./SkillUnitConst', 'DB/Effects/EffectConst'], function( SU, EC )
{
	...
	SkillUnit[SU.UNT_BLASTMINE] =			EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_SKIDTRAP] =			EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_ANKLESNARE] =			'ef_anklesnare';	// Tofix
	SkillUnit[SU.UNT_VENOMDUST] =			EC.EF_VENOMDUST2;
	SkillUnit[SU.UNT_LANDMINE] =			EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_SHOCKWAVE] =			EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_SANDMAN] =				EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_FLASHER] =				EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_FREEZINGTRAP] =		EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_CLAYMORETRAP] =		EC.EF_NONE;	// Todo
	SkillUnit[SU.UNT_TALKIEBOX] =			EC.EF_NONE;	// Todo
