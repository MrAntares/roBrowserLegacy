 ...
 *
 *  i do not own this file i just update and add some function -MicromeX
 */
define(function(require)
{
	...
	function pickUpItem() {
		...
		console.log(`Sent pick-up packet for item ID: ${pickUpPacket.ITAID}`);
	}
	...
	function moveCharacter(x, y, tileSize) {
			return new Promise((resolve) => {
				...
				if (targetPos[0] !== newPos[0] || targetPos[1] !== newPos[1]) {
					...
					console.log(`Moving to (${movePacket.dest[0]}, ${movePacket.dest[1]})`);
    ...
    function talkToNearestNpc() {
        ...
        if (!nearestNpc) {
            console.warn("No NPC found within 3 tiles!");
            return;
        }
        ...
        console.log(`Talking to NPC: ${nearestNpc.name} (GID: ${nearestNpc.NAID})`);
		}
