...
function autoTarget() {
	...
	const closestEntity = EntityManager.getClosestEntity(Player, Session.Character.constructor.TYPE_MOB);
...
function pickUpItem() {
	...
	const closestItem = EntityManager.getClosestEntity(player, Session.Character.constructor.TYPE_ITEM);
