/**
 * UI/Components/SkillListHOM/SkillListHOM.js
 *
...
define(function(require)
{
	...
	var htmlText             = require('text!./SkillListHOM.html');
	var cssText              = require('text!./SkillListHOM.css');
	 ...
	 * Create Component
	 */
	var SkillListHOM = new UIComponent( 'SkillListHOM', htmlText, cssText );


	/**
	 * @var {Preferences} window preferences
	 */
	var _preferences = Preferences.get('SkillListHOM', {
		x:        100,
		y:        200,
		width:    8,
		height:   5,
	 ...
	 * Initialize UI
	 */
	SkillListHOM.init = function init()
	{
		...
		_btnLevelUp.click(function(){
			_btnLevelUp.detach();
			SkillListHOM.ui.show();
			SkillListHOM.ui.parent().append(SkillListHOM.ui);
	 ...
	 */
	SkillListHOM.onAppend = function onAppend()
	{
		// Apply preferences
	 ...
	 */
	SkillListHOM.onRemove = function onRemove()
	{
		_btnLevelUp.detach();
	 ...
	 * Show/Hide UI
	 */
	SkillListHOM.toggle = function toggle()
	{
		this.ui.toggle();
	 ...
	 */
	SkillListHOM.setSkills = function setSkills( skills )
	{
		var i, count;
	 ...
	 * @param {object} skill
	 */
	SkillListHOM.addSkill = function addSkill( skill )
	{
		// Custom skill ?
		...
		SkillListHOM.ui.find('.content table').append(element);
	 ...
	 */
	SkillListHOM.removeSkill = function removeSkill()
	{
	 ...
	 */
	SkillListHOM.updateSkill = function updateSkill( skill )
	{
	 ...
	 */
	SkillListHOM.useSkillID = function useSkillID( id, level )
	{
		...
		SkillListHOM.useSkill( skill, level ? level : skill.selectedLevel );
	};
	 ...
	 * @param {object} skill
	 */
	SkillListHOM.useSkill = function useSkill(skill, level )
	{
		// Self
	 ...
	 */
	SkillListHOM.setPoints = function SetPoints( amount )
	{
		var i, count;
	 ...
	 */
	SkillListHOM.onLevelUp = function onLevelUp()
	{
	...
	/**
	 * Extend SkillListHOM window size
	 */
	function onResize()
	{
		var ui      = SkillListHOM.ui;
	...
	function resize( width, height )
	{
		...
		SkillListHOM.ui.find('.content').css({
			width:  width  * 32,
			height: height * 32
		});
	}
	...
	function onRequestUseSkill()
	{
		...
		SkillListHOM.useSkillID(parseInt(main.data('index'), 10));
	}
	...
	function onSkillFocus()
	{
		...
		SkillListHOM.ui.find('.skill').removeClass('selected');
	...
	function skillLevelSelectUp( skill ){
		...
		if (level < skill.level){
			...
			var element = SkillListHOM.ui.find('.skill.id' + skill.SKID + ':first');
			element.find('.level .current').text(skill.selectedLevel);
		}
	}
	 ...
	 */
	SkillListHOM.onUseSkill      = function onUseItem(){};
	SkillListHOM.onIncreaseSkill = function onIncreaseSkill() {};
	SkillListHOM.onUpdateSkill   = function onUpdateSkill(){};
	SkillListHOM.getSkillById    = getSkillById;


	/**
	 * Create component and export it
	 */
	return UIManager.addComponent(SkillListHOM);
});
