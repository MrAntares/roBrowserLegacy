		...
		this.ui.find('.up button').mousedown(function ()
		{
			switch (this.className)
			{
				case 'str':
					...
					break;
				case 'agi':
					WinStatsV1.onRequestUpdate(14, 1);
					break;
				case 'vit':
					WinStatsV1.onRequestUpdate(15, 1);
					break;
				case 'int':
					WinStatsV1.onRequestUpdate(16, 1);
					break;
				case 'dex':
					WinStatsV1.onRequestUpdate(17, 1);
					break;
				case 'luk':
					WinStatsV1.onRequestUpdate(18, 1);
					break;
			}
		});
	};
