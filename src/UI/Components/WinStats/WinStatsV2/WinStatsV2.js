...
WinStatsV2.init = function init() {
	...
	this.ui.find('.up button').mousedown(function () {
		switch (this.className) {
			case 'str':
				WinStatsV2.onRequestUpdate(13, 1);
				break;
			case 'agi':
				WinStatsV2.onRequestUpdate(14, 1);
				break;
			case 'vit':
				WinStatsV2.onRequestUpdate(15, 1);
				break;
			case 'int':
				WinStatsV2.onRequestUpdate(16, 1);
				break;
			case 'dex':
				WinStatsV2.onRequestUpdate(17, 1);
				break;
			case 'luk':
				WinStatsV2.onRequestUpdate(18, 1);
				break;
		}
	});

	this.ui.find('.titlebar .mini').click(function () {
		WinStatsV2.ui.find('.panel').toggle();
	});
	...
	switch (type) {
		case 'statuspoint':
			...
			this.ui.find('.requirements div').each(function () {
				WinStatsV2.ui.find('.up .' + this.className).css({
...
export default UIManager.addComponent(WinStatsV2);
