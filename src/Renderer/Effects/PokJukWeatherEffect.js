...
define(function(require) {
	...
	PokJukWeatherEffect.prototype.updateFirework = function(fw) {
		...
		if (fw.process > 0) {
			...
			else if (fw.state === 1) { // EXPLOSION PHASE
		...
		if (fw.state === 0) {
			...
			for (var i = 0; i < fw.particles.length; i++) {
				...
				if (p.alpha > 0) {
					...
					switch(p.colorType) {
						case 0: r=100; g=160; b=255; break; // Blue
  						case 1: r=255; g=100; b=100; break; // Red
						case 2: r=100; g=255; b=100; break; // Green
						case 3: r=255; g=255; b=130; break; // Yellow
						case 4: r=255; g=130; b=255; break; // Pink
						default: r=255; g=255; b=255; break; // White (Gunpowder)
					}
