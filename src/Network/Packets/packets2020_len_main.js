/**
 * Network/Packets/packets2020_len_main.js
 *
...
define(function () {
	...
	function init(packetver) {
		...
		} else if (packetver >= 20200122) {
			length_list[0x0b70] = 8;
		}
		...
		} else if (packetver >= 20201104) {
			length_list[0x0b94] = 10;
		}
