/**
 * Network/Packets/packets2018_len_main.js
 *
...
define(function () {
	...
	function init(packetver) {
		...
		} else if (packetver >= 20180307) {
			length_list[0x0202] = 2;
		} else if (packetver >= 20180221) {
			length_list[0x0202] = 90;
		} else if (packetver >= 20180124) {
			length_list[0x0202] = 2;
		} else if (packetver >= 20180117) {
		...
		} else if (packetver >= 20180314) {
			length_list[0x0281] = 2;
		} else if (packetver >= 20180307) {
			length_list[0x0281] = 4;
		} else if (packetver >= 20180213) {
			length_list[0x0281] = 2;
		} else if (packetver >= 20180207) {
		...
		} else if (packetver >= 20180321) {
			length_list[0x0ae7] = 34;
		} else if (packetver >= 20180103) {
		...
		} else if (packetver >= 20180829) {
			length_list[0x0b05] = 59;
		}
		...
		} else if (packetver >= 20180912) {
			length_list[0x0b08] = 27;
		} else if (packetver >= 20180829) {
			length_list[0x0b08] = 26;
		}
