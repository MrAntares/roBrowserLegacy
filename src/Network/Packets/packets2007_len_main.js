/**
 * Network/Packets/packets2007_len_main.js
 *
...
define(function () {
	...
	function init(packetver) {
		...
		} else if (packetver >= 20070108) {
			length_list[0x0072] = 14;
		} else if (packetver >= 20070102) {
		...
		} else if (packetver >= 20070416) {
			// removed
		} else if (packetver >= 20070227) {
			length_list[0x0287] = -1;
		}
		...
		} else if (packetver >= 20070423) {
			length_list[0x0288] = 6;
		} else if (packetver >= 20070416) {
			// removed
		} else if (packetver >= 20070227) {
			length_list[0x0288] = 6;
		...
		} else if (packetver >= 20070122) {
			length_list[0x029b] = 72;
		} else if (packetver >= 20070102) {
		...
		if (packetver >= 20070611) {
			length_list[0x02a6] = 22;
		}

		// Packet: 0x02a7
		if (packetver >= 20070611) {
			length_list[0x02a7] = 22;
		}

		// Packet: 0x02a8
		if (packetver >= 20070611) {
			length_list[0x02a8] = 162;
		}

		// Packet: 0x02a9
		if (packetver >= 20070611) {
			length_list[0x02a9] = 58;
		}
		...
		if (packetver >= 20070807) {
			// removed
		} else if (packetver >= 20070711) {
			length_list[0x02ae] = 10;
		}
		...
		} else if (packetver >= 20070813) {
			length_list[0x02b3] = 103;
		} else if (packetver >= 20070731) {
			length_list[0x02b3] = 31;
		} else if (packetver >= 20070703) {
			length_list[0x02b3] = 7;
		} else if (packetver >= 20070622) {
			length_list[0x02b3] = 26;
		}
		...
		} else if (packetver >= 20070807) {
			// removed
		} else if (packetver >= 20070703) {
			length_list[0x02b5] = 12;
		} else if (packetver >= 20070622) {
			length_list[0x02b5] = 18;
		}
		...
		} else if (packetver >= 20070611) {
			length_list[0x02ba] = 9;
		}

		// Packet: 0x02bb
		if (packetver >= 20070622) {
			length_list[0x02bb] = 8;
		} else if (packetver >= 20070605) {
			length_list[0x02bb] = 4;
		}
		...
		// Packet: 0x02bf
		if (packetver >= 20070807) {
			length_list[0x02bf] = 10;
		}

		// Packet: 0x02c0
		if (packetver >= 20070807) {
			length_list[0x02c0] = 2;
		}
		...
		if (packetver >= 20070828) {
			// removed
		} else if (packetver >= 20070821) {
			length_list[0x02c3] = 4;
		}
		...
		} else if (packetver >= 20070828) {
			length_list[0x02cb] = 20;
		}
